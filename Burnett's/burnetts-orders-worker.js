...
//   NOTIFY_EMAIL  → jamesallenwalsh@gmail.com (swap to Shane's email when he signs)
// Bindings to add in Worker Settings → Bindings → Email:
//   EMAIL         → sending address: orders@barriewebautomation.com
